...
// Verificação se BULL_DASHBOARD_ROUTE está definido
if (!process.env.BULL_DASHBOARD_ROUTE) {
    throw new Error("A variável de ambiente BULL_DASHBOARD_ROUTE não está definida.");
}

...
const { CALLONLINE_ENDPOINT } = require(path.resolve('src/lib/magnusbilling/endpoints/clients/callonline'))
const { CALLERID_ENDPOINT } = require(path.resolve('src/lib/magnusbilling/endpoints/clients/callerid'))
const { ATALINKSYS_ENDPOINT } = require(path.resolve('src/lib/magnusbilling/endpoints/clients/atalinksys'))

// Billing
const { REFILL_ENDPOINT } = require(path.resolve('src/lib/magnusbilling/endpoints/billing/refill'))

// Dids
const { DIDS_ENDPOINT } = require(path.resolve('src/lib/magnusbilling/endpoints/dids/dids'))
const { DIDDESTINATION_ENDPOINT } = require(path.resolve('src/lib/magnusbilling/endpoints/dids/diddestination'))

// Rates
const { PREFIXES_ENDPOINT } = require(path.resolve('src/lib/magnusbilling/endpoints/rates/prefixes'))
const { PLANS_ENDPOINT } = require(path.resolve('src/lib/magnusbilling/endpoints/rates/plans'))
const { TARIFFS_ENDPOINT } = require(path.resolve('src/lib/magnusbilling/endpoints/rates/tariffs'))
const { OFFERS_ENDPOINT } = require(path.resolve('src/lib/magnusbilling/endpoints/rates/offers'))

// Routes
const { TRUNKS_ENDPOINT } = require(path.resolve('src/lib/magnusbilling/endpoints/routes/trunks'))
const { PROVIDERS_ENDPOINT } = require(path.resolve('src/lib/magnusbilling/endpoints/routes/providers'))
const { TRUNKGROUPS_ENDPOINT } = require(path.resolve('src/lib/magnusbilling/endpoints/routes/trunkgroups'))
